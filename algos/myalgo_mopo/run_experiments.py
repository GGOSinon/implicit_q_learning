...
start_command = 'mkdir ~/.mujoco &&' \
		...
		'PYTHONPATH="." python train_myalgo_mopo.py --config $config --env_name $env_name --seed $seed --cql_weight 0.0 --rollout_length $rollout_length --model_batch_ratio $model_batch_ratio --horizon_length 5 --expectile 0.1 --num_layers 3 --layer_size 256 --wandb_key $WANDB_KEY'

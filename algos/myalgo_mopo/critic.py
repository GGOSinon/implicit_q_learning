...
# COMBO
def update_q(key: PRNGKey, critic: Model, target_critic: Model, value: Model, actor: Model, model: Model,
    ...
    for i in reversed(range(H)):
        #q1, q2 = target_critic(states[i+1], actions[i+1]); next_value = jnp.minimum(q1, q2)
